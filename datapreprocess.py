...
cub_dataset='C:/Users/hello/Desktop/Accads/CUB_200_2011/'
captions_dataset='C:/Users/hello/Desktop/Accads/cvpr2016_cub/word_c10/'
...
with h5py.File(os.path.join('dataset.hdf5'), 'w') as h:
    ...
    with open(cub_dataset + 'images.txt') as f:
        for i,line in enumerate(f):
            ...
            if img.shape!=(256,256,3):  # Ask TAs what to do?
