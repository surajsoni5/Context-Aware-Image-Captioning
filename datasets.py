...
class CaptionDataset(Dataset): # Confirm about speed and stuff.. Ask TAs a better way
    ...
    def __init__(self, transform):
        ...
        self.class_ =np.array(self.h['class'])
        self.maxcapslen=30+2 #FIXME
    ...
    def __getitem__(self, i):
        ...
        class_ = torch.LongTensor([self.class_[i // self.capsperimage]])
        if caplen<2:
            print(caplen,class_,i)
        return img,caption,caplen,class_
